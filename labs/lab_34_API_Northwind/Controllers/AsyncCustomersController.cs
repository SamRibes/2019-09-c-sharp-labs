...
{
    public class AsyncCustomersController : ApiController
    {
        private NorthwindEntities db = new NorthwindEntities();

        // GET: api/AsyncCustomers
        public IQueryable<Customer> GetCustomers()
        {
            return db.Customers;
        }

        // GET: api/AsyncCustomers/5
